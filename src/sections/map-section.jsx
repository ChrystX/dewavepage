            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div className="grid lg:grid-cols-5 gap-0 min-h-[300px] sm:min-h-[400px]">
                        ...
                        <div className={`lg:col-span-2 bg-gradient-to-br from-white to-gray-50 flex flex-col transform transition-all duration-1000 ${
                            ...
                            <div className="flex-1 px-6 sm:px-8 lg:px-12 py-6 sm:py-8 flex flex-col justify-center">
                                <div className="max-w-sm">
                                    <h2 className="text-2xl sm:text-3xl font-light mb-4 sm:mb-6 leading-tight" style={{ color: '#836953' }}>
                                        Visit Our Academy
                                    </h2>
                                    ...
                                    <div className="space-y-4 sm:space-y-6 text-gray-700">
                                        <div className={`transform transition-all duration-700 delay-200 ${
                                            ...
                                            <h3 className="text-xs sm:text-sm font-medium uppercase tracking-wide mb-2" style={{ color: '#836953' }}>
                                                Location
                                            </h3>
                                        ...
                                        <div className={`pt-2 transform transition-all duration-700 delay-800 ${
                                            ...
                                            <button
                                                className="inline-flex items-center text-xs font-medium tracking-wide uppercase transition-all duration-300 hover:opacity-70 hover:transform hover:translate-x-1 bg-white border border-gray-200 px-3 py-2 rounded-lg shadow-sm hover:shadow-md group"
                                                style={{ color: '#836953' }}
                        ...
                        <div className={`lg:col-span-3 relative overflow-hidden transform transition-all duration-1000 delay-300 ${
                            locationInView ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'
                        }`}>
                            <LocationMap
                                width="100%"
